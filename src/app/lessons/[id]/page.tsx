            ...
            <main className='container py-8'>
                ...
                <article className='max-w-4xl mx-auto'>
                    ...
                    <div className='relative h-[400px] rounded-xl overflow-hidden mb-8'>
                        {lesson.mainImage ? (
                            <Image src={lesson.mainImage} alt={lesson.title} fill className='object-cover' priority />
                        ) : (
                            ...
                            <div className='grid grid-cols-2 md:grid-cols-3 gap-4'>
                                {lesson.gallery.map((image) => (
                                    <div key={image.id} className='relative aspect-square rounded-lg overflow-hidden'>
                                        ...
                                        />
                                        {image.caption && (
                                            <div className='absolute bottom-0 left-0 right-0 bg-black/50 text-white p-2 text-sm'>{image.caption}</div>
                                        )}
                                    </div>
                                ))}
                            </div>
                    ...
                    {lesson.url && (
                        <div className='mb-12'>
                            ...
                            >
                                <Button variant='secondary' className='bg-sky-700 hover:bg-sky-900 text-white hover:text-white' size='xl'>
